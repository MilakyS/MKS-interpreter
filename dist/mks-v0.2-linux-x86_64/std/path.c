...
void std_init_path(RuntimeValue exports, Environment *module_env) {
    ...
    bind(exports, "basename", n_basename);
    bind(exports, "dirname", n_dirname);
    bind(exports, "extname", n_extname);
    bind(exports, "stem", n_stem);
    bind(exports, "normalize", n_normalize);
}
